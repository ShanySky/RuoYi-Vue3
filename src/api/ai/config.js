...
export function testAiModelLoad(data) { return request({ url: '/ai/config/provider/test-model-load', method: 'post', data, headers: { repeatSubmit: false } }) }
export function discoverAiModels() { return request({ url: '/ai/config/models/discover', method: 'post', headers: { repeatSubmit: false } }) }
export function addAiModels(modelCodes) { return request({ url: '/ai/config/models', method: 'post', data: { modelCodes }, headers: { repeatSubmit: false } }) }
...
export function testAiModelChat(modelId) { return request({ url: `/ai/config/models/${modelId}/test-chat`, method: 'post', headers: { repeatSubmit: false } }) }
export function testAiModelTools(modelId) { return request({ url: `/ai/config/models/${modelId}/test-tools`, method: 'post', headers: { repeatSubmit: false } }) }
export function detectAiModelCapabilities(modelId) { return request({ url: `/ai/config/models/${modelId}/detect-capabilities`, method: 'post', headers: { repeatSubmit: false } }) }
