...
import { toolBuildPageContract } from '@/ai/pages/toolPageCapabilities'
...
const buildAiCapabilities = createAiCrudPageCapabilities({
  contract: toolBuildPageContract,
  bindings: {
    getContext: () => ({
...
useAiPageTools(toolBuildPageContract, buildAiCapabilities.tools, buildAiCapabilities.getContext)
