...
import { systemPostPageContract } from "@/ai/pages/systemPageCapabilities"
...
const postAiCapabilities = createAiCrudPageCapabilities({
  contract: systemPostPageContract,
  bindings: {
    query: {
      apply: async args => {
...
useAiPageTools(systemPostPageContract, postAiCapabilities.tools, postAiCapabilities.getContext)
